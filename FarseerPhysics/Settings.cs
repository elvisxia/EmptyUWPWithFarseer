...
namespace FarseerPhysics
{
    public static class Settings
    {
        ...
        /// </summary>
        public static int VelocityIterations = 8;   // *ACK* was 8 (eight)

        /// <summary>
        /// The number of position iterations used in the solver.
        /// </summary>
        public static int PositionIterations = 3;   // *ACK* was 3 (three)

        /// <summary>
        /// Enable/Disable Continuous Collision Detection (CCD)
        /// </summary>
        public static bool ContinuousPhysics = true;    // *ACK* If yo need continuous collision detection then set to TRUE
        ...
        /// This is in meters.
        /// </summary>
        public const float AABBExtension = 0.2f;    // *ACK* was 0.1f
